      ...
      <div id="a1" class="form">
        <form action="index.php" onSubmit="return searchInput();" method="get">
          ...
          <div class="formstyle">
            ...
            <input name="" type="submit" class="search-button" value="搜索">
          </div>
        </form>
      </div>
      <div class="tag">
...
<div class="content">
  <div id="all-category">
    <div class="title">
      <h2 title="<?php echo $lang['nc_all_goods_class'];?>"><a href="index.php?act=category"><?php echo $lang['nc_all_goods_class'];?></a></h2>
      <i></i> </div>
    <div id="category" class="category pngFix">
      <ul class="menu">
        ...
        ?>
        <li id="cat_<?php echo $sign;?>" <?php if($sign>9){?>style="display:none;"<?php }?>>
          <h3><span class="block"><a href="index.php?act=search&cate_id=<?php echo $val['gc_id'];?>" title="<?php echo $val['gc_name']?>"><?php echo $val['gc_name']?></a></span> 
 ...
 <div class="mini_cart">
      <div class="minicart_box"> <a class="mini_cart_btn" href="index.php?act=cart"><?php echo $lang['nc_cart'];?>(<span class="mini_cart_goods_num"><?php echo intval($output['cart_goods_num']); ?></span>)</a>
        <div class="minicart_list" style="display: none; ">
          <div class="list_detail"><div class="none_tips">您的购物车中暂无商品，赶快选择心爱的商品吧！</div></div>
        </div>
      </div>
      <a class="check_out" href="index.php?act=cart">去结算</a> </div>
        <div class="clear"></div>
</div></div>
