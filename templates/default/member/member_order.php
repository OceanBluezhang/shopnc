  ...
  <table class="order ncu-table-style">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="bdl" rowspan="<?php echo count($val);?>">
        	<?php if(($v['order_state'] >= 20 && $v['order_state'] < 40 && $v['payment_code'] != 'cod') && ($v['payment_code'] == 'predeposit' || C('payment') == 0)) { ?>
            
            <?php if ($v['refund_state'] == 0){?>
            <p><a href="javascript:void(0)" nc_type="dialog" dialog_title="<?php echo $lang['member_order_refund'];?>" dialog_id="member_order_refund" dialog_width="400" uri="index.php?act=member_refund&op=add&order_id=<?php echo $v['order_id']; ?>" id="order<?php echo $v['order_id']; ?>_action_refund">
            <?php echo $lang['member_order_refund'];?></a></p>
            <?php } elseif ($v['refund']['refund_state'] == 1){?>
            <p><a href="javascript:void(0)" nc_type="dialog" dialog_title="<?php echo $lang['member_order_refund'];?>" dialog_id="member_order_refund" dialog_width="400" uri="index.php?act=member_refund&op=add&order_id=<?php echo $v['order_id']; ?>" id="order<?php echo $v['order_id']; ?>_action_refund">
            <?php echo $lang['member_refund_confirm'];?></a></p>
            <?php }?>
          ...
          <?php } elseif ($v['order_state'] >= 20 && $v['order_state'] < 40 && $v['payment_code'] != 'cod'){?>
          	...
          	<?php if ($v['order_state'] == 30 && $v['return_state'] == 0){?>
          	<p><a href="javascript:void(0)" nc_type="dialog" dialog_title="<?php echo $lang['member_order_return'];?>" dialog_id="member_order_return" dialog_width="400" uri="index.php?act=member_return&op=add&order_id=<?php echo $v['order_id']; ?>" id="order<?php echo $v['order_id']; ?>_action_return">
          	<?php echo $lang['member_order_return'];?></a>
            </p>
          	<?php } elseif ($v['order_state'] == 30 && $v['return']['return_state'] == 1){?>
          	<p><a href="javascript:void(0)" nc_type="dialog" dialog_title="<?php echo $lang['member_order_return'];?>" dialog_id="member_order_return" dialog_width="400" uri="index.php?act=member_return&op=view&return_id=<?php echo $v['return']['return_id']; ?>" id="order<?php echo $v['order_id']; ?>_action_return">
          	<?php echo $lang['member_return_confirm'];?></a>
            </p>
          	<?php }?>
          <?php }?>
